...
import { Search, Bell, MessageSquare, Menu, LogOut, ChevronDown, User, Settings } from 'lucide-react';
import { useAuth } from '../../hooks/useAuth';
import { useNavigate } from 'react-router-dom';
import { getNotifications } from '../../services/notification.api';

export default function InstructorHeader({ onToggleMobile }) {
      ...
      <div className="flex items-center gap-3 flex-1 max-w-xl">
        ...
        <div className="relative w-full">
          ...
          <input
            ...
            className="w-full rounded-xl py-2 pl-10 pr-20 text-xs sm:text-sm border outline-none transition"
            style={{
          ...
          />
          <div
            className="hidden sm:flex absolute right-2.5 top-1/2 -translate-y-1/2 items-center rounded-md px-1.5 py-0.5 text-[10px] font-medium border"
            style={{
          ...
          {dropdownOpen && (
            ...
            >
              ...
              >
                ...
                <p className="text-[10px] text-slate-400">{instructorRole}</p>
              </div>
